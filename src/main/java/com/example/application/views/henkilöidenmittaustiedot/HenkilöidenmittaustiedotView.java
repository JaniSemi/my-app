...
@Uses(Icon.class)
public class HenkilöidenmittaustiedotView extends Div implements BeforeEnterObserver {
    ...
    public HenkilöidenmittaustiedotView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("henkilöidenmittaustiedot-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(HenkilöidenmittaustiedotView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(HenkilöidenmittaustiedotView.class);
            }
        }
    }
